...
def main():
    ...
    PIL_time = (t1 - process_begin)/ datetime.timedelta(milliseconds=1)
    torch_time = (t2 - t1)/ datetime.timedelta(milliseconds=1)
    torchvison_time = (t3-t2)/ datetime.timedelta(milliseconds=1)
    resnet152_time = (lib_end-t3)/ datetime.timedelta(milliseconds=1)
    ...
    return {
        ...
        'measurement': {
            ...
            'torchvison_time':torchvison_time,
            'resnet152_time':resnet152_time
        }
    }
